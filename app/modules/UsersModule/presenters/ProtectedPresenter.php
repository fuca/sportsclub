...
class ProtectedPresenter extends SecuredPresenter {
	...
	try {
	    ...
	    $this->handleDataLoad($uUser->getId(), "Protected:default", $e);
	}
    }
	...
	try {
	   ...
	   switch ($ex->getCode()) {
	    ...
	    $this->handleDataSave($values->id, "Protected:default", $ex);
	}
    }
	...
	try {
	    ...
	    $this->handleDataLoad($uWp->getId(), "Protected:default", $ex);
	}
    }
	...
	try {
	    ...
	    $this->handleDataLoad($wp->getId(), "Protected:default", $e);
	}
    }
	...
	try {
	    ...
	    $this->handleDataSave($user->getId(), "Protected:default", $ex);
	}
